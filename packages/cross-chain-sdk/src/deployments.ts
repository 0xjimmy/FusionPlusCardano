...
// Placeholder addresses for Cardano networks (these would need to be actual Cardano addresses)
const CardanoPlaceholderAddress = new Address('0x0000000000000000000000000000000000000000')
...
export const TRUE_ERC20 = {
    ...
    // Custom networks
    [CustomNetworkEnum.CARDANO_PREVIEW]: CardanoPlaceholderAddress,
    [CustomNetworkEnum.CARDANO]: CardanoPlaceholderAddress,
    [CustomNetworkEnum.SEPOLIA]: TrueERC20
}
...
export const ESCROW_SRC_IMPLEMENTATION = {
    ...
    [CustomNetworkEnum.CARDANO_PREVIEW]: CardanoPlaceholderAddress,
    [CustomNetworkEnum.CARDANO]: CardanoPlaceholderAddress,
    [CustomNetworkEnum.SEPOLIA]: ESCROW_SRC_IMPLEMENTATION_ADDRESS
}
...
export const ESCROW_DST_IMPLEMENTATION = {
    ...
    [CustomNetworkEnum.CARDANO_PREVIEW]: CardanoPlaceholderAddress,
    [CustomNetworkEnum.CARDANO]: CardanoPlaceholderAddress,
    [CustomNetworkEnum.SEPOLIA]: ESCROW_DST_IMPLEMENTATION_ADDRESS
}
...
export const ESCROW_FACTORY = {
    ...
    [CustomNetworkEnum.CARDANO_PREVIEW]: CardanoPlaceholderAddress,
    [CustomNetworkEnum.CARDANO]: CardanoPlaceholderAddress,
    [CustomNetworkEnum.SEPOLIA]: ESCROW_FACTORY_ADDRESS
}
